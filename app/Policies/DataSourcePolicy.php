...
class DataSourcePolicy
{
    ...
    {
        return $user->can('view_any_data::source');
    }
    ...
    {
        return $user->can('view_data::source');
    }
    ...
    {
        return $user->can('create_data::source');
    }
    ...
    {
        return $user->can('update_data::source');
    }
    ...
    {
        return $user->can('delete_data::source');
    }
    ...
    {
        return $user->can('delete_any_data::source');
    }
     ...
     */
    public function replicate(User $user, DataSource $dataSource): bool
    {
